            ...
            <div className="space-y-16 md:space-y-24">
              ...
              <div className="flex flex-col md:flex-row items-center group journey-item">
                ...
                <div className="flex items-center justify-center md:w-16 z-10 mb-4 md:mb-0 order-1 md:order-2">
                  <div className="bg-white p-3 rounded-full border border-gray-100 shadow-sm group-hover:shadow-md transition-all duration-500 relative">
                    <div className="timeline-marker absolute w-4 h-4 bg-gray-200 rounded-full left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 z-[-1]"></div>
                    <Image src="/images/about_us/A1.webp" alt="Launch Day" width={30} height={30} className="group-hover:scale-110 transition-transform duration-300" />
                  </div>
                </div>
              ...
              <div className="flex flex-col md:flex-row items-center group journey-item">
                ...
                <div className="flex items-center justify-center md:w-16 z-10 mb-4 md:mb-0 order-1 md:order-2">
                  <div className="bg-white p-3 rounded-full border border-gray-100 shadow-sm group-hover:shadow-md transition-all duration-500 relative">
                    <div className="timeline-marker absolute w-4 h-4 bg-gray-200 rounded-full left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 z-[-1]"></div>
                    <Image src="/images/about_us/A2.webp" alt="Goals" width={30} height={30} className="group-hover:scale-110 transition-transform duration-300" />
                  </div>
                </div>
                <div className="md:w-1/2 md:pl-12 order-3">
                  <h3 className="text-xl font-normal text-[#1875d1] mb-2">Goals</h3>
                  <p className="text-gray-500 font-light">Set by UNFCCC and UNEP</p>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row items-center group journey-item">
                ...
                <div className="flex items-center justify-center md:w-16 z-10 mb-4 md:mb-0 order-1 md:order-2">
                  <div className="bg-white p-3 rounded-full border border-gray-100 shadow-sm group-hover:shadow-md transition-all duration-500 relative">
                    <div className="timeline-marker absolute w-4 h-4 bg-gray-200 rounded-full left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 z-[-1]"></div>
                    <Image src="/images/about_us/A3.webp" alt="Focus" width={30} height={30} className="group-hover:scale-110 transition-transform duration-300" />
                  </div>
                </div>
                <div className="md:w-1/2 md:pl-12 order-3"></div>
              </div>
              ...
              <div className="flex flex-col md:flex-row items-center group journey-item">
                ...
                <div className="flex items-center justify-center md:w-16 z-10 mb-4 md:mb-0 order-1 md:order-2">
                  <div className="bg-white p-3 rounded-full border border-gray-100 shadow-sm group-hover:shadow-md transition-all duration-500 relative">
                    <div className="timeline-marker absolute w-4 h-4 bg-gray-200 rounded-full left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 z-[-1]"></div>
                    <Image src="/images/about_us/A4.webp" alt="Unite" width={30} height={30} className="group-hover:scale-110 transition-transform duration-300" />
                  </div>
                </div>
                <div className="md:w-1/2 md:pl-12 order-3">
