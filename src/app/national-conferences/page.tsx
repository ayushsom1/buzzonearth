   ...
   {/* Council Awards Section */}
      ...
      <section>
          ...
          {[
            ...
            <div key={index} className="flex items-center justify-center w-35 h-35 rounded-full bg-white border-4 border-[#E6F3FF] p-4 text-center font-medium hover:border-[#0066FF] transition-colors duration-300">
              {text}
            </div>
          ))}
        </div>
      ...
      <section className="relative flex items-center justify-center bg-gradient-to-b from-[#001428] to-[#002952] text-white px-4 py-16">
