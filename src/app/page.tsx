    ...
    <div className="flex flex-col">
      ...
      <section className="py-5 bg-white flex justify-center h-auto">
        <div className="container px-4">
          {/* First Row */}
          <div className="grid grid-cols-4 md:grid-cols-6 lg:grid-cols-12 mb-5 items-center">
          ...
          {/* Second Row */}
          <div className="grid grid-cols-4 md:grid-cols-6 lg:grid-cols-12 items-center">
      ...
      <section className="relative min-h-[800px] md:min-h-[700px] lg:h-[700px] flex justify-center items-center">
        {/* Background Image */}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-6xl mx-auto mb-20">
            ...
            <div className="md:hidden">
              {/* Upper Section: Image + Title + Button */}
              <div className="flex flex-col sm:flex-row items-center gap-6 mb-8">
                ...
                <div className="flex flex-col items-center text-center">
                  <h2 className="text-xl font-bold mb-2">YOUTH LEADERSHIP <br /> PROGRAM</h2>
          ...
          <div className="max-w-6xl mx-auto mb-20">
            ...
            <div className="md:hidden">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-6 mb-8">
                ...
                <div className="flex flex-col items-center text-center">
                  <h2 className="text-xl font-bold mb-2">INDIA'S YOUNG<br />FOREST<br />AMBASSADOR</h2>
                  <p className="text-sm mb-2">Registrations Open!</p>
                  <Button className="bg-[#1875d1] text-white px-6 py-2">
                    Enroll Now
                  </Button>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="md:hidden">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-6 mb-8">
                ...
                <div className="flex flex-col items-center text-center">
                  <h2 className="text-xl font-bold mb-2">BuzzOnEarth <br />INDIA<br />HACKATHON</h2>
